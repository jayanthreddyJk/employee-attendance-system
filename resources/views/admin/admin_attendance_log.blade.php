...
<head>
    ...
    <title>Ardhas Time Tracker | Attendance Log</title>
    ...
    <section class="container">
        <div class="mt-5">
            <div class="d-flex justify-content-between">
                ...
                <input type="text" id="attendanceDate" class="form-control mb-3 w-25" placeholder="Select Date">
            </div>
            <div>
            </div>
       </div>
       <div>
            <ul class="list-unstyled d-flex gap-3">
                <li><a href="{{route('attendance.export')}}" class="btn btn-success"><i class="bi bi-file-spreadsheet"></i> Export as Excel</a></li>
                <li><a href="{{route('export.emp.attendance.pdf')}}" class="btn btn-danger"><i class="bi bi-file-earmark-pdf"></i> Export as PDF</a></li>
            </ul>
       </div>
    </section>
    <div class="container">
