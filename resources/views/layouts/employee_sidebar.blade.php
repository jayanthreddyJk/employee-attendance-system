...
<body>
    <div class="navbar px-3 navbar-dark align-items-center">
        ...
        <div class=" text-center ">
            <p class="navbar-brand mb-0 greeting"  data-bs-toggle="popover" data-bs-html="true" data-bs-content="<a href='#'>Settings</a>"><i class="bi bi-person-circle pe-3"></i>Hi, {{Auth::guard('employee')->user()->name}}</p>
        </div>
    </div>
    <div class="offcanvas offcanvas-start sidebar" style="width: 300px" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            <ul class="list-unstyled ps-4 pt-4 fs-5">
                <li class="mb-3"><a class="text-decoration-none text-white " href="{{url('employee_dashboard')}}"><i class="bi bi-house pe-3"></i>Dashboard</a></li>
                <li class="mb-3"><a class="text-decoration-none text-white " href="{{url('employee_attendance_log')}}"><i class="bi bi-person-lines-fill pe-3"></i>Attendance Log</a></li>
                <li class="mb-3"><a class="text-decoration-none text-white " href="{{url('employee_attendance_history')}}"><i class="bi bi-file-earmark-spreadsheet pe-3"></i>Attendance History</a></li>
